...
| **Qualitätsverantwortung** | Kurs 2 (SQM) | Qualität des **gleichen** Projekts sichern: Teststrategie, Reviews, DoD-Prüfung, Metriken, **UI/UX-Tests (Lautes Denken)**, **Nutzungsanleitung mit Guidde**, Prozesse – **parallel** zur Entwicklung. |
...
- **Gemeinsames Backlog:** Qualitäts-Stories (z. B. „Integrationstest Session-Flow“, „Review-Checkliste für Epic 2“) stehen im selben Backlog oder in einer klar verlinkten SQM-Liste; beide Kurse kennen die DoD und die gleichen Konventionen (AGENT.md, cursor-context).
...
| **SQM-Rolle** | Teststrategie, Reviews, DoD, Metriken/Audits, **UI/UX-Tests (Lautes Denken)**, **Nutzungsanleitung mit Guidde**, Prozesse – am gleichen Repo und Backlog. |
