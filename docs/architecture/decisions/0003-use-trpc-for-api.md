...
Wir verwenden **tRPC** als API-Schicht. Das Frontend importiert die Router-Typen direkt aus dem Backend über den `libs/shared-types`-Pfad im Monorepo. Dadurch entsteht **100% End-to-End Typsicherheit** ohne Code-Generierung.
